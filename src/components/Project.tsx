...
const techTags = ["Next.js", "TypeScript", "Tailwind CSS"];
          ...
          <div className="glass grid overflow-hidden rounded-3xl md:grid-cols-2">
            ...
            >
              ...
              >
                <Image
                  ...
                  alt="DriveKit auto parts e-commerce platform built with Next.js and TypeScript"
                  width={1200}
                  height={572}
            ...
            <div className="flex flex-col justify-center p-8 md:p-12 lg:pe-12 lg:ps-4">
              ...
              <div className="flex flex-wrap gap-3.5">
                <a
                  href="https://drive-kit1.vercel.app"
                  target="_blank"
