...
const translations = {
  en: {
    ...
    "project.desc": "I developed a complete e-commerce platform for automotive parts — a full shopping cart with persistent state, a multi-criteria filtering system for fast part discovery, and custom UI animations tuned to make the whole experience feel quicker than it is.",
  ...
  fa: {
    ...
    "project.desc": "یک پلتفرم فروشگاهی کامل برای قطعات خودرو توسعه دادم — یک سیستم سبد خرید کامل با وضعیت پایدار، یک سیستم فیلتر چندمعیاره برای یافتن سریع قطعات، و انیمیشن‌های اختصاصی که کل تجربه را سریع‌تر از آنچه واقعاً هست نشان می‌دهد.",
